...
public extension ReportContent {
    ...
    static var reportContent202006: ReportContent {
        ReportContent(
            ...
            footerString: "ИТОГ всех расходов за месяц:\t92.531р15к\t\t\n\t\t\t\nФактический остаток:\t173.753 \t20%\t\n\t\t\t\n"
        )
    }
